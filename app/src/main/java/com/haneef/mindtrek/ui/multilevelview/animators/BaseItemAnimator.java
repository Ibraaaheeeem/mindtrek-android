package com.haneef.mindtrek.ui.multilevelview.animators;
/*
...
public abstract class BaseItemAnimator extends SimpleItemAnimator {
    ...
    private void doAnimateRemove(final ViewHolder holder) {
        if (holder instanceof AnimateViewHolder) {
            ((AnimateViewHolder) holder).animateRemoveImpl((ViewPropertyAnimatorListener) new DefaultRemoveVpaListener(holder));
        } else {
